...
for amount1 in range(sum // coin_val1, -1, -1):
    remaining1  = sum - amount1 * coin_val1
    for amount2 in range(remaining1  // coin_val2, -1, -1):
        remaining2  = remaining1  - amount2 * coin_val2
        if coin_val3 != 0 and remaining2 % coin_val3 == 0: # Третий цикл убран
            amount3 = remaining2  // coin_val3
